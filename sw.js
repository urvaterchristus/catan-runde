...
const FILES=['./','./index.html','./styles.css','./app.js','./model.js','./pwa.js','./touch.js','./cloud.js','./shared.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./apple-touch-icon.png'];
